...
export default function PropertyDetail({ prop, isFav, onFav, setPage }) {
  ...
  const [msg, setMsg] = useState(
    `Hola, me interesa la propiedad "${prop.title}". ¿Podrían darme más información?`,
  );
  const [sent, setSent] = useState(false);

  const prev = () =>
    setImgIdx((i) => (i - 1 + prop.imgs.length) % prop.imgs.length);
  ...
  const waMsg = encodeURIComponent(
    `Hola, vi la propiedad "${prop.title}" en GOWS Propiedades y me gustaría obtener más información.`,
  );
      ...
      <div className="detail-content">
        <div className="detail-main">
          ...
          <div className="detail-header">
            <span className={`detail-op-badge badge-${prop.op}`}>
              {prop.op}
            </span>
          ...
          <div className="detail-features">
            {prop.rooms > 0 && (
              <div className="detail-feat">
                <div className="detail-feat-icon">
                  <Bed size={22} />
                </div>
            ...
            {prop.parking > 0 && (
              <div className="detail-feat">
                ...
                <strong>{prop.parking}</strong>
                <span>Cochera{prop.parking > 1 ? "s" : ""}</span>
              </div>
            )}
          </div>
          ...
          <div className="detail-section">
            ...
            >
              {[
                ...
                {
                  label: "Antigüedad",
                  val: prop.age === 0 ? "A estrenar" : `${prop.age} años`,
                },
          ...
          <div className="contact-card">
            ...
            >
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <button
                  onClick={() => onFav(prop.id)}
                  style={{
                    padding: "8px",
                    border: `1px solid ${isFav ? "#ef4444" : "var(--border)"}`,
                    borderRadius: "8px",
                    background: "none",
                    cursor: "pointer",
                    color: isFav ? "#ef4444" : "var(--text-sec)",
                    display: "flex",
                    alignItems: "center",
                  }}
                >
            ...
            {sent ? (
              ...
              <form className="contact-form" onSubmit={handleSend}>
                ...
                <a
                  href={`https://wa.me/5491128831895?text=${waMsg}`}
                  target="_blank"
                  rel="noreferrer"
